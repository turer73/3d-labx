UPDATE posts SET content_tr = '<p class="intro">Bambu Lab yazıcılar (X1 Carbon, P1S, P1P, A1, A1 Mini) yüksek kaliteli baskılar üretir ancak bazı yaygın sorunlarla karşılaşabilirsiniz. Bu rehberde en sık görülen 4 sorunu ve doğrulanmış çözümlerini bulacaksınız.</p>
...
<figure style="margin:20px 0;text-align:center;">
<img src="https://pub-9142f11355e84e1da1dd96a4c14e4afb.r2.dev/images/1769944165060-81xrtt.webp" alt="İlk Katman Yapışmama Sorunu" style="max-width:100%;border-radius:12px;" />
<figcaption style="color:#888;font-size:0.85em;margin-top:10px;">İlk katman yapışmama sorunu - filament tablaya tutunmuyor</figcaption>
</figure>
...
<figure style="margin:20px 0;text-align:center;">
<img src="https://pub-9142f11355e84e1da1dd96a4c14e4afb.r2.dev/images/1769944473385-428eue.webp" alt="Layer Shift ve Stringing Sorunu" style="max-width:100%;border-radius:12px;" />
...
<p style="margin-top:30px;padding:15px;background:rgba(0,174,66,0.1);border-radius:8px;font-size:0.9em;"><strong>Kaynak:</strong> Bu rehber <a href="https://wiki.bambulab.com" target="_blank" rel="noopener">Bambu Lab Wiki</a> ve topluluk deneyimlerinden derlenmiştir.</p>' WHERE id = 449;
