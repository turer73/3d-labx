UPDATE posts SET 
  image_url = 'https://us.store.bambulab.com/cdn/shop/files/P1S_01_1200x.png',
...
<img src="https://us.store.bambulab.com/cdn/shop/files/P1S_01_1200x.png" alt="Bambu Lab P1S 3D Yazıcı" style="width:100%;max-width:600px;border-radius:12px;margin:20px auto;display:block;" />
...
<img src="https://wiki.bambulab.com/x1/troubleshooting/images/nozzle-clog-cold-pull.png" alt="Bambu Lab Nozzle Temizleme - Cold Pull" style="width:100%;max-width:500px;border-radius:12px;margin:20px auto;display:block;background:#fff;padding:10px;" />
...
<img src="https://wiki.bambulab.com/x1/troubleshooting/images/warping-example.png" alt="3D Baskıda Warping Sorunu" style="width:100%;max-width:500px;border-radius:12px;margin:20px auto;display:block;background:#fff;padding:10px;" />
...
<img src="https://wiki.bambulab.com/ams/troubleshooting/images/ams-loading-failure.png" alt="Bambu Lab AMS Filament Hatası" style="width:100%;max-width:500px;border-radius:12px;margin:20px auto;display:block;background:#fff;padding:10px;" />
...
<img src="https://wiki.bambulab.com/x1/troubleshooting/images/layer-shift-example.png" alt="3D Baskıda Katman Kayması" style="width:100%;max-width:500px;border-radius:12px;margin:20px auto;display:block;background:#fff;padding:10px;" />
