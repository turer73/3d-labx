UPDATE posts SET 
  title_tr = 'Bambu Lab Yazıcılarda Sık Karşılaşılan Sorunlar ve Çözümleri (X1, P1, A1 Serisi)',
  summary_tr = 'Bambu Lab X1, P1 ve A1 serisi yazıcılarda en sık karşılaşılan 4 sorun: Nozzle tıkanıklığı, tablaya yapışmama, AMS geri çekme hatası ve katman kayması. Her biri için doğrulanmış çözüm yöntemleri.',
  slug = 'bambu-lab-yazicilarda-sik-karsilasilan-sorunlar-ve-cozumleri-x1-p1-a1-serisi',
