UPDATE posts SET 
  image_url = 'https://cdn.shopify.com/s/files/1/0570/6328/0075/files/01-P1S-combo_1200x.png',
...
<div style="background:#1a1a2e;padding:20px;border-radius:12px;margin:20px 0;text-align:center;">
<img src="https://i.imgur.com/7KhMN3C.png" alt="Nozzle Tıkanıklığı - Cold Pull Yöntemi" style="max-width:100%;border-radius:8px;" onerror="this.style.display=''none''" />
<p style="color:#888;font-size:0.85em;margin-top:10px;">Cold Pull (Soğuk Çekme) yöntemi ile nozzle temizliği</p>
</div>
...
<div style="background:#1a1a2e;padding:20px;border-radius:12px;margin:20px 0;text-align:center;">
<img src="https://www.3djake.com/cdn-cgi/image/fit=contain,q=85,w=1200/uploads/media/images/prevent-warping/3d-drucker-warping-ecken-heben-ab-verformen-_4_.jpg" alt="3D Baskıda Warping Sorunu" style="max-width:100%;border-radius:8px;" />
<p style="color:#888;font-size:0.85em;margin-top:10px;">Warping: Köşelerin tabladan kalkması</p>
</div>
...
<div style="background:#1a1a2e;padding:20px;border-radius:12px;margin:20px 0;text-align:center;">
<img src="https://cdn.shopify.com/s/files/1/0570/6328/0075/files/AMS_1200x.png" alt="Bambu Lab AMS" style="max-width:100%;border-radius:8px;" />
<p style="color:#888;font-size:0.85em;margin-top:10px;">Bambu Lab AMS (Automatic Material System)</p>
</div>
...
<div style="background:#1a1a2e;padding:20px;border-radius:12px;margin:20px 0;text-align:center;">
<img src="https://www.3djake.com/cdn-cgi/image/fit=contain,q=85,w=1200/uploads/media/images/layer-shift/layer-shift-benchy.png" alt="Katman Kayması Örneği" style="max-width:100%;border-radius:8px;" />
<p style="color:#888;font-size:0.85em;margin-top:10px;">Layer Shift: Katmanların yatay kayması</p>
</div>
